...
namespace gw2f {
    namespace bxml2 {
        ...
        void XmlElement::insertChild( XmlElement* p_element, XmlElement* p_insertBefore )
        {
            ...
            throw exception::Exception( "This should never, ever happen. If it does, it means an XML element has its parent set to an object that does not contain it." );
        }
        ...
        void XmlElement::clear( )
        {
            ...
            for ( auto attrib = m_attributes.begin( ); attrib != m_attributes.end( ); attrib++ )
            {
                delete* attrib;
            }
        ...
        void XmlElement::removeAttribute( XmlAttribute* p_attribute )
        {
            ...
            throw exception::Exception( "This should never, ever happen. If it does, it means an XML attribute has its parent set to an object that does not contain it." );
        }
        ...
        {
            m_value = p_value;
            m_value.erase( std::remove_if( m_value.begin( ), m_value.end( ), [](unsigned char c){ return std::isspace( c ); } ), m_value.end( ) );
        }
